...
#
# This script shows how to flip an image.
# Flipping an image is essentially rotating it around an axes.
# Horizantal flipping is around Y-axis and Vertical flipping is around X-axis.
...
ap.add_argument("-i", "--image", default=DATA_DIR / "images/sunset.jpg", help="Input image to perform flipping operation")
